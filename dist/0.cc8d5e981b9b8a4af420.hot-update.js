...
var _io = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"io\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
var Score = function () {
	function Score() {
		...
		this.socket = _io2.default.io("http://172.16.22.156:3000");

		console.log(_io2.default);
	}
