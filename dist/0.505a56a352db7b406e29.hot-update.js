...
var _socket = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"socket\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	_createClass(Score, [{
		...
		value: function setReady() {
			...
			_socket.socket.on('connect', function () {
				...
				_socket.socket.emit('add user', data, function (resp) {
					console.log(resp);
				});
			});
		}
